...
class RegistroMedico(models.Model):
    ...
    doctor = models.ForeignKey("usuarios.Usuario", on_delete=models.SET_NULL, null=True,
...
class DispensacionMedicamentos(models.Model):
    ...
    fecha_dispensa = models.DateTimeField(default=timezone.now, verbose_name="Fecha de Dispensa")
    administrado_por = models.ForeignKey("usuarios.Usuario", on_delete=models.SET_NULL, null=True,
